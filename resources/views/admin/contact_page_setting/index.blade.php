    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form action="{{ route('admin.contact-page-setting.store') }}" method="POST"
    ...
    @push('js-internal')
        <script>
            function btnAdd() {
                ...
                let url = "{{ route('admin.contact-page-setting.store') }}";
                $('#default-modal form').attr('action', url);
            }

            function btnEdit(id) {
                let url = "{{ route('admin.contact-page-setting.update', ':id') }}";
                url = url.replace(':id', id);
                $.ajax({
                    url: "{{ route('admin.contact-page-setting.show', ':id') }}".replace(':id', id),
                    type: "GET",
                    dataType: "JSON",
